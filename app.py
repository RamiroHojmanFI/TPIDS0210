...
def home(): 
    ...
    return render_template('index.html', mensaje='lolazo', envio =info_evento) 
...
def registro():
    ...
    if request.method == "POST":
        ...
        msg.body = f"Hola {nombre} {apellido}, te registraste con el email {email} en la modalidad {modalidad}."
